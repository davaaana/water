    ...
    angular.module("ui.grid").config(["$provide", function (a) {
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("en", {
                ...
                sort: {ascending: "Өсөхөөр", descending: "Буурахаар", remove: "Эрэмбийг болих"},
                column: {hide: "Баганыг хаах"},
                ...
                pagination: {sizes: "items per page", totalItems: "items"}
            }), a
        }])
    }])
}(), function () {
